...
g++ "lab2/time/matMultEigenTime.cpp" -o "lab2/time/matMultEigenTime" -O2 -I . -Wall
g++ "lab2/timeofday/matMultTimeofDay.cpp" -o "lab2/timeofday/matMultTimeofDay" -O2 -Wall
g++ "lab2/timeofday/matMultEigenTimeofDay.cpp" -o "lab2/timeofday/matMultEigenTimeofDay" -O2 -I . -Wall
